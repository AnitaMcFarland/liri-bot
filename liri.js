...
var queryUrl = "https://rest.bandsintown.com/artists/" + artist + "/events?app_id=codingbootcamp".then(function (data) { // This line is just to help us debug against the actual URL.
            ...
            request(queryUrl, function (error, response, body) {
                ...
                if (!error && response.statusCode === 200) {
                    ...
                    console.log("Name of the venue: " + bandsintown.Name),
                    console.log("Venue location: " + bandsintown.Location),
                    console.log("Date of the Event: " + bandsintown.concertTime.
                    moment("HH:mm"));
